...
contract dTSLA is FunctionsClient, ConfirmedOwner, ERC20, Pausable {
    ...
    // get the donID for your supported network https://docs.chain.link/chainlink-functions/supported-networks
    bytes32 s_donID;
    ...
    // @note not a good way to put hardcoded minimum redemption amount 
